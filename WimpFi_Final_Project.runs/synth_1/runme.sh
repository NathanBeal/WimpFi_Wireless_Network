...
HD_PWD='D:/Scool/ECE 416/ece416_Bachman_Beal/WimpFi_Final_Project/WimpFi_Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WimpFi_Hardware_TL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WimpFi_Hardware_TL.tcl
